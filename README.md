# ORGANIZAÇÃO E ABSTRAÇÃO NA PROGRAMAÇÃO (Turma CCOM2N)

# 📝 Sistema de estoque/cadastro em python.
...
# Essa estrutura permite inserções dinâmicas sem limite pré-definido de tamanho.
